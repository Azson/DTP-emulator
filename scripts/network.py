...
def create_trace(change_scale=5, unchanged=4, cov=0.2, time_length=50, min_bitrate = 0.2, max_bitrate = 8):
    '''
...
def create_network(row, length, min_bitrate, max_bitrate):
    for idx in range(length * 5, length * 6):
        trace_list = []
